...

{
	...
	sudo wget ${SRC}/scripts/mupibox/get_network.sh -O /usr/local/bin/mupibox/check_network.sh >&3 2>&3
	sudo wget ${SRC}/scripts/mupibox/get_network.sh -O /usr/local/bin/mupibox/check_network.py >&3 2>&3
