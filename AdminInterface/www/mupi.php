...
<?php
	...
	if( $data["timeout"]["idlePiShutdown"]!=$_POST['idlePiShutdown'] && $_POST['idlePiShutdown'])
		{
		$data["timeout"]["idlePiShutdown"]=$_POST['idlePiShutdown'];
		$change=1;
		}
	if( $data["timeout"]["idleDisplayOff"]!=$_POST['idleDisplayOff'] && $_POST['idleDisplayOff'])
		{
...
?>
                ...
                <form class="appnitro"  method="post" action="mupi.php">
