...
<?php
	...
	exec('rrdtool graph /var/www/images/cpuload.png --start -15m -a PNG -t "Load Average" --vertical-label "Average Load" -w 600 -h 100 DEF:load1=/tmp/.rrd/cpuusage.rrd:load1:AVERAGE DEF:load5=/tmp/.rrd/cpuusage.rrd:load5:AVERAGE DEF:load15=/tmp/.rrd/cpuusage.rrd:load15:AVERAGE VDEF:load1l=load1,LAST VDEF:load5l=load5,LAST VDEF:load15l=load15,LAST AREA:load1#ff0000:"1 Minute, last\:" GPRINT:load1l:"%5.2lf\n" AREA:load5#ff9900:"5 Minutes, last\:" GPRINT:load5l:"%5.2lf Grafik erzeugt am\n" AREA:load15#ffff00:"15 Minutes, last\:" GPRINT:load15l:"%5.2lf $(/bin/date "+%d.%m.%Y %H\:%M\:%S")" LINE1:load5#ff9900:"" LINE1:load1#ff0000:"" > /dev/null');
