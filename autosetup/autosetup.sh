...

{
	...
	sudo wget https://raw.githubusercontent.com/splitti/MuPiBox/main/themes/darkred.css -O ~/MuPiBox/themes/darkred.css >&3 2>&3
	...
	sudo wget https://raw.githubusercontent.com/splitti/MuPiBox/main/scripts/mupibox/get_network.sh -O /usr/local/bin/mupibox/get_network.sh >&3 2>&3
	...
	ln -s /tmp/network.json /home/dietpi/.mupibox/Sonos-Kids-Controller-master/server/config/network.json	#sudo /boot/dietpi/func/dietpi-set_swapfile 1 zram >&3 2>&3
