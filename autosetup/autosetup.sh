...

{
	...
	if [ "$(getconf LONG_BIT)" = "32" ]; then
		wget -O /usr/bin/librespot https://github.com/friebi/MuPiBox/raw/refs/heads/develop/bin/librespot/dev_0.6_20250806/librespot-32bit >&3 2>&3
		mv ${MUPI_SRC}/bin/fbv/fbv /usr/bin/fbv >&3 2>&3
	else
		wget -O /usr/bin/librespot https://github.com/friebi/MuPiBox/raw/refs/heads/develop/bin/librespot/dev_0.6_20250806/librespot-64bit >&3 2>&3
