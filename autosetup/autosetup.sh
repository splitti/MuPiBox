...

{
	...
	if [ `getconf LONG_BIT` == 32 ]; then
		...
		mv ${MUPI_SRC}/bin/librespot/0.6.6_20250305/librespot-32bit /usr/bin/librespot >&3 2>&3
		...
		mv ${MUPI_SRC}/bin/librespot/0.6.6_20250305/librespot-64bit /usr/bin/librespot >&3 2>&3
